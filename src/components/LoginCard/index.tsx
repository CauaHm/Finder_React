      ...
      <div className={styles.containerLogin}>
        <div className={styles.contentLogin}>
          ...
          <div className={`${styles.firstColumn} ${styles.column}`}>
            {isSignInActive ? (
              <>
                <h2 className={`${styles.titleLogin} ${styles.titlePrimary}`}>
                  Bem-vindo!
                </h2>
                <p
                  className={`${styles.descriptionLogin} ${styles.descriptionPrimary}`}
                >
                  Para se manter conectado
                </p>
                <button
                  onClick={handleToggle}
                  className={`${styles.btnLogin} ${styles.btnPrimary}`}
                >
                  Entrar
                </button>
              </>
              ...
              <>
                ...
                <p
                  className={`${styles.descriptionLogin} ${styles.descriptionPrimary}`}
                >
                  Digite seus dados pessoais e comece a jornada conosco
                </p>
                <button
                  onClick={handleToggle}
                  className={`${styles.btnLogin} ${styles.btnPrimary}`}
          ...
          <div className={`${styles.secondColumn} ${styles.column}`}>
            {isSignInActive ? (
              <>
                <h2 className={`${styles.titleLogin} ${styles.titleSecond}`}>
                  Faça login no Finder
                </h2>

                {/* Ícones sociais */}
                <div className={styles.socialMediaLogin}>
                  <ul className={styles.listSocialMedia}>
                    <a className={styles.linkSocialMedia} href="#">
                ...
                <p
                  className={`${styles.descriptionLogin} ${styles.descriptionSecond}`}
                >
                ...
                <form onSubmit={handleLogin} className={styles.formLogin}>
                  ...
                  <a className={styles.passwordLogin} href="#">
                    esqueceu sua senha?
                  </a>
                  <button className={`${styles.btnLogin} ${styles.btnSecond}`}>
                    Entrar
                  </button>
                </form>
              </>
